<li>
	<a target="_blank" href="https://twitter.com/modernnotion" class="icon-twitter-c"><span class="sr-only">Twitter</span></a>
</li>
<li>
...
<li class="rss-feed-item">
	<a target="_blank" href="<?php bloginfo('rss2_url'); ?>" title="RSS Feed" class="icon-feed"><span class="sr-only">RSS Feed</span></a>
</li>