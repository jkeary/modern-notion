...
<head>
    ...
    <?php if(is_single()) :  ?>
        ...
        <meta property="og:url" content="<?php echo wpbitly_get_shortlink(get_permalink(), $post->ID); ?>" />
        ...
        <meta name="twitter:url" content="<?php echo wpbitly_get_shortlink(get_permalink(), $post->ID); ?>" />
    <?php endif; ?>
